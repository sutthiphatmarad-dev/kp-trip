    ...
    try:
        ...
        for line in ai_text.split('\n'):
            ...
            if imatch and imatch.group(1) in icon_dict:
                ...
                if re.search(r'(อาหาร|กิน|ข้าว|คาเฟ่|กาแฟ)', line):
                    extracted_icon = 'ICON_FOOD'
                elif re.search(r'(วัด|พระ|ทำบุญ|ประวัติศาสตร์)', line):
                    extracted_icon = 'ICON_TEMPLE'
                elif re.search(r'(น้ำตก|อุทยาน|ธรรมชาติ|เขา|ช่องเย็น|แก่ง)', line):
                    extracted_icon = 'ICON_NATURE'
                elif re.search(r'(พัก|โรงแรม|รีสอร์ท|นอน)', line):
